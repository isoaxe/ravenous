...
function searchYelp(term, location, priceString, sortBy) {
  return fetch(`https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=${term}&location=${location}&price=${priceString}&sort_by=${sortBy}`, {headers: {Authorization: `Bearer ${apiKey}`}})
